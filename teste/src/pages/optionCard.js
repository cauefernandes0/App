                ...
                <View className='px-3 pb-4x space-y-2'>
                    ...
                    <View className='flex-row items-center space-x-1'>
                        ...
                        <Text className="text-xs">
                            ...
                            <Text className="text-gray-700">({item.reviews}k reviews) . <Text className="font-semibold">{item?.type?.name}</Text>
                            </Text>
                        </Text>
                    </View>
                    <View className="flex-row items-center space-x-1">
                        <Icon.MapPin color="gray" width="15" height="15"/>
                        <Text className="text-gray-700 text-xs">Perto . Em {item.adress}</Text>
                    </View>
                </View>
            </View>
